package roambin.mongoutils.utils;
...
public class HdfsUtils {
    ...
    public static void main(String[] args) throws Exception{
        ...
        HdfsUtils.putString(fileSystem, "123", filename, true);
        String s = HdfsUtils.getString(fileSystem, filename);
        HdfsUtils.delete(fileSystem, filename);
